namespace HotelJJ.DataAccess.Http.Models.Facturacion.Requests;

public class PagoCreateFacturacionRequestModel
{
...
public class PagoSimularFacturacionRequestModel
{
    public int IdReserva { get; set; }
    public decimal Monto { get; set; }
