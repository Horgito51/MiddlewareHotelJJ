...
public class PagedAlojamientoResponse<T>
{
...
public class AlojamientoSearchItemResponse
{
...
public class AlojamientoDetailResponse : AlojamientoSearchItemResponse
{
    public string? DescripcionCompleta { get; set; }
    public List<AlojamientoRoomTypeResponse> TiposHabitacion { get; set; } = new();
    public List<AlojamientoTariffResponse> TarifasActivas { get; set; } = new();
...
public class AlojamientoTariffResponse
{
...
public class AlojamientoPolicyResponse
{
    public string? HoraCheckIn { get; set; }
    public string? HoraCheckOut { get; set; }
    public bool AceptaNinos { get; set; }
...
public class AlojamientoAvailabilityByRoomTypeResponse
{
    public Guid TipoHabitacionGuid { get; set; }
    public string Nombre { get; set; } = string.Empty;
...
public class AlojamientoReviewResponse
{
...
public class AlojamientoHabitacionResponse
{
