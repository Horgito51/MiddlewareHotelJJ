...
public class AlojamientoSearchDTO
{
...
public class AlojamientoDetailQueryDTO
{
    public DateTime? FechaEntrada { get; set; }
    public DateTime? FechaSalida { get; set; }
}

public class AlojamientoReviewsQueryDTO
{
    public int Pagina { get; set; } = 1;
    public int Limite { get; set; } = 10;
}

public class AlojamientoHabitacionesQueryDTO
{
